...
# ---------------------------------------------------------------
# Henter alle meteorologiske observationer fra DMI Open Data API
# for station 06031 fra en given startdato og frem.
#
# Scriptet håndterer API'ets pagination ved at følge "next"-linket
# indtil der ikke er flere sider. Alle observationer samles i
# all_features.
#
# Efter hentning:
#   - Udtrækkes alle unikke parameterId (typer af målinger)
#   - Temperaturmålinger (parameterId="temp_dry") filtreres ud
#     sammen med deres observationstidspunkt og stationId
#   - Rå data gemmes i "clean_features_all.txt"
#   - Temperaturdata gemmes i "clean_features_temp_dry_all.txt"
#
# Output inkluderer:
#   - Antal hentede features
#   - Antal temperaturmålinger
#   - Første og sidste observationstidspunkt for temp_dry
# ---------------------------------------------------------------

base_url = "https://opendataapi.dmi.dk/v2/metObs/collections/observation/items?stationId=06031&datetime=2026-05-08T02:00:00%2B02:00/.."
